...
exec(
  ...
  (initErr, initStdout, initStderr) => {
    ...
    // locally and needs to be downloaded. See https://github.com/jonahgeek/create-reusable-react-app/issues
    https.get(
      "https://github.com/jonahgeek/create-reusable-react-app/blob/master/.gitignore",
      (res) => {
